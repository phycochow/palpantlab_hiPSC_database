...
output:
  html_document:
    ...
    toc_depth: 3
params:
  datfile: "../results/round2_final/ukb31063_ldsc_sumstat_manifest_aws_sep2022.tsv.gz"
---
...
dat$gwas_dl <- gsub("dl=0","dl=1",dat$gwas_aws)
...
The full GWAS results are available for download from AWS. A full manifest of the available files, with links and documentation, are available [here](https://docs.google.com/spreadsheets/d/1kvPoupSzsSFBNSztMzl04xMoSC3Kcx3CrjVf4yBmESU/edit#gid=227859291). 
