...
#      filter = "top",
      ...
      extensions = c('Buttons'),
		  options = list(scrollY="475px", scrollX=TRUE, pageLength=15, autoWidth=FALSE,
...
* `z7 finngen` for highly significant $h^2_g$ results for ICD10-based endpoints defined by [FinnGen](https://www.finngen.fi/en/researchers/clinical-endpoints)
...
| Name | Description |
|------------|------------------------------------------------------------|
| **ID** (hidden) | either the UK Biobank phenotype code (e.g. matching the [UKB Showcase](http://biobank.ctsu.ox.ac.uk/crystal/index.cgi)), an ICD10 code, or a [FinnGen](https://www.finngen.fi/en/researchers/clinical-endpoints) endpoint code |
...
| **Source** | the GWAS batch the phenotype belonged to. One of: [PHESANT](https://github.com/astheeggeggs/PHESANT), ICD10, [FinnGen](https://www.finngen.fi/en/researchers/clinical-endpoints), or biomarkers. |
